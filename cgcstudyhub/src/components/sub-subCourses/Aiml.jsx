...
export default function AIML() {
  ...
  useEffect(() => {
    ...
    // ✅ placeholder for cleanup (important if Navbar adds listeners)
    return () => {};
  }, []);
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-all">
      ...
      <div className="max-w-6xl mx-auto px-6 py-25">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-center text-indigo-600 dark:text-white mb-12">
          <span className="text-indigo-600">AIML Journey</span>
        </h1>
...
const SemesterCard = React.memo(({ sem, navigate }) => {
  ...
  const handleNavigate = () => {
    const routes = {
      1: "/btech/aiml/firstsemester",
      2: "/btech/aiml/secondsemester",
      3: "/btech/aiml/thirdsemester",
      4: "/btech/aiml/fourthsemester",
      5: "/btech/aiml/fifthsemester",
      6: "/btech/aiml/sixthsemester",
      7: "/btech/aiml/seventhsemester",
    };
