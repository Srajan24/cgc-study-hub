...
export default function AIDS() {
  ...
  useEffect(() => {
    ...
    // ✅ cleanup in case future event listeners are added
    return () => {
      // nothing yet, but safe for expansion
    };
  }, []);
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-all">
      ...
      <div className="max-w-6xl mx-auto px-6 py-25">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-center text-indigo-600 dark:text-white mb-12">
          <span className="text-indigo-600">AIDS Journey</span>
        </h1>
...
const SemesterCard = React.memo(({ sem, navigate }) => {
  ...
  const handleNavigate = () => {
    const routes = {
      1: "/btech/aids/firstsemester",
      2: "/btech/aids/secondsemester",
      3: "/btech/aids/thirdsemester",
      4: "/btech/aids/fourthsemester",
      5: "/btech/aids/fifthsemester",
      6: "/btech/aids/sixthsemester",
      7: "/btech/aids/seventhsemester",
    };
