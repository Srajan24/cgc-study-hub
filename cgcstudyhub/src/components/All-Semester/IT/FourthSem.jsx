...
import { ITsem4subject } from "../../../Constants/courses";
...
const FourthSemester = () => {
    ...
    const sem4WithWT = [
        ...sem4Subjects,
        ...(sem5Subjects?.find(sub => sub.subject === "CN") ? [sem5Subjects.find(sub => sub.subject === "CN")] : [])
      ];
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[...(Array.isArray(ITsem4subject) ? ITsem4subject : []), 
                              ...sem4Subjects, 
                              ...(sem5Subjects || []).filter(sub => sub?.subject === "CN"), 
                              ...(sem3Subjects || []).filter(sub => sub?.subject === "DOS")]
