...
import { ITSem3subject } from "../../../Constants/courses";
        ...
        >
          ...
          <div className="w-full max-w-4xl space-y-8">
            <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
              {[...(Array.isArray(ITSem3subject) ? ITSem3subject : []),
              ...sem3Subjects,
              ...(sem4Subjects || []).filter(sub => sub?.subject === "COA")]
                .filter(subject => subject) // Filter out any undefined/null subjects
                .map((subject, index) => (
                  <SubjectBlock key={index} subject={subject} delay={index * 0.1} />
                ))}
