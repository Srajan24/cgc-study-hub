...
import { AIDSSem6Subjects } from "../../../Constants/AI";
import { ITsem6subject } from "../../../Constants/courses";
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[...(Array.isArray(ITsem6subject) ? ITsem6subject : []),
                            ...sem6Subjects,
                            ...(sem5Subjects || []).filter(sub => sub?.subject === "WT (Elective)"),
                            ...(AIDSSem6Subjects || []).filter(sub => sub?.subject === "Big Data Analytics")]
                                .filter(subject => subject?.subject && !excludedSubjects.includes(subject.subject.trim()))
