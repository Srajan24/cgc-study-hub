...
import { AIDSSem5Subject,ECE7semsubjects } from "../../../Constants/AI";
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[
                                ...sem5Subjects, 
                                ...sem6Subjects.filter(sub => sub.subject === "AI (Artificial Intelligence)"), 
                                ...sem6Subjects.filter(sub => sub.subject === "ML (Machine Learning)"),
                                ...ECE7semsubjects.filter(sub => sub.subject === "Python"),
                                ...AIDSSem5Subject
                            ]
