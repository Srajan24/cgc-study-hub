...
import { sem5Subjects, sem7Subjects, sem6Subjects } from "../../../../Constants";
import { AIDSSem7Subjects } from "../../../Constants/AI";

const FifthSemester = () => {
    const navigate = useNavigate();
    const excludedSubjects = [
        "COI", "WT (Elective)", "ERP", "DBMS", "SE", "FLAT" , "EXAM PAPERS"];

    const sem5withAI = [
        ...sem5Subjects,
        sem6Subjects.find(sub => sub.subject === "CD (Compiler Design)")
    ];
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[...sem5Subjects, ...sem6Subjects.filter(sub => sub.subject === "CD (Compiler Design)"), ...sem7Subjects.filter(sub => sub.subject === "R&S (Routing & Switching)"),
                            ...AIDSSem7Subjects.filter(sub => sub.subject === "Computer Vision" || "Business Intelligence")]
