...
import { ecesem4subject } from "../../../Constants/courses";
        ...
        >
          ...
          <div className="w-full max-w-4xl space-y-8">
            <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
              {[ ...ecesem4subject,...sem4Subjects, ...sem3Subjects.filter(sub => sub.subject === "DSA"),]
...
const UnitLink = ({ unit, delay }) => {
  ...
  const getBadgeColor = () => {
    ...
    if (label.includes("notes") || label.includes("unit") || label.includes("module")) return "bg-green-600";
    ...
    if (label.includes("question bank")) return "bg-cyan-600";
