...
import { sem6Subjects, sem4Subjects, sem5Subjects } from "../../../../Constants";
import { ecesem6subject } from "../../../Constants/courses";
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[...ecesem6subject, ...sem6Subjects, ...sem4Subjects.filter(sub => sub?.subject === "OS"), ...sem5Subjects.filter(sub => sub?.subject === "CN")]
