...
import {ecesem3subject} from "../../../Constants/courses";
        ...
        >
          ...
          <div className="w-full max-w-4xl space-y-8">
            <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
              {ecesem3subject.map((subject, index) => (
...
const UnitLink = ({ unit, delay }) => {
  ...
  const getBadgeColor = () => {
    ...
    if (label.includes("topics")) return "bg-cyan-600";
    if (label.includes("solved")) return "bg-purple-600";
    return "bg-gray-600";
  };
