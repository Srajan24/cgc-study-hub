...
import { sem4Subjects, sem5Subjects } from "../../../../Constants";
import {ECE7semsubjects} from "../../../Constants/AI";
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[...ECE7semsubjects, ...sem4Subjects.filter(sub => sub?.subject === "OS"), ...sem5Subjects.filter(sub => sub?.subject === "CN")]
...
const UnitLink = ({ unit, delay }) => {
    ...
    const getBadgeColor = () => {
        ...
        if (label.includes("all")) return "bg-emerald-600";
        return "bg-gray-600";
      };
