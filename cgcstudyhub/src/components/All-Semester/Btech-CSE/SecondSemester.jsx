...
const UnitLink = ({ unit, delay }) => {
  ...
  const getBadgeColor = () => {
    ...
    if (label.includes("lab")) return "bg-cyan-600";
    if (label.includes("qb")) return "bg-red-600";
    if (label.includes("Teachers Notes")) return "bg-emerald-600";
    if (label.includes("lords")) return "bg-emerald-600";
    return "bg-gray-600";
  };
