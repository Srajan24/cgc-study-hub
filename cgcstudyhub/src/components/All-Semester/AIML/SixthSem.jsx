...
import { sem7Subjects, sem6Subjects,sem5Subjects} from "../../../../Constants";
import { AIMLSem6Subject ,AIDSSem6Subjects} from "../../../Constants/AI";
...
const SemesterNotesPage = () => {
  ...
  const sem7withWC = [
    ...sem7Subjects,
    sem6Subjects.find(sub => sub.subject === "WC (Web Technologies)")
  ];
        ...
        >
          ...
          <div className="w-full max-w-4xl space-y-8 text-">
            <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
              {[
                ...sem7Subjects,
                ...sem6Subjects.filter(sub => sub.subject === "WC (Web Technologies)"),
                ...sem6Subjects.filter(sub => sub.subject === "ML (Machine Learning)"),
                ...sem5Subjects.filter(sub => sub.subject === "CN"),
                ...AIDSSem6Subjects,
                ...AIMLSem6Subject
              ]
...
const UnitLink = ({ unit, delay }) => {
    ...
    const getBadgeColor = () => {
        ...
        if (label.includes("cec")) return "bg-emerald-600";
        if (label.includes("qb")) return "bg-yellow-600";
