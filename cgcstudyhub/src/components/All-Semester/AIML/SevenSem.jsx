...
import { sem6Subjects, sem7Subjects } from "../../../../Constants";
import { sem7AIMLSubjects, AIDSSem7Subjects } from "../../../Constants/AI";
        ...
        >
          ...
          <div className="w-full max-w-4xl space-y-8 text-">
            <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
              {[
                ...sem7AIMLSubjects,
                ...sem6Subjects.filter(sub => sub.subject === "CD (Compiler Design)"),
                ...sem7Subjects.filter(sub => sub.subject === "R&S (Routing & Switching)"),
                ...AIDSSem7Subjects.filter(sub => sub.subject === "Computer Vision"),
              ]
