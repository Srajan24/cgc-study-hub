...
import { sem5Subjects , sem6Subjects  } from "../../../../Constants";
import { AIMLSem5Subject ,AIDSSem5Subject} from "../../../Constants/AI";
import { ITSem5Subjects ,ECE7semsubjects } from "../../../Constants/AI";
...
const FifthSemester = () => {
    ...
    const sem5withAI = [
        ...sem5Subjects,
        sem6Subjects.find(sub => sub.subject === "AI (Artificial Intelligence)")
    ];
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {[...sem5Subjects, ...sem6Subjects.filter(sub => sub.subject === "AI (Artificial Intelligence)"),...ITSem5Subjects.filter(sub => sub?.subject === "Programming in Java"),...ECE7semsubjects.filter(sub => sub?.subject === "Python"),
                                ...AIDSSem5Subject,
                                ...AIMLSem5Subject
                            ] 
...
const UnitLink = ({ unit, delay }) => {
    ...
    const getBadgeColor = () => {
        ...
        if (label.includes("2022")) return "bg-cyan-600";
        if (label.includes("coe")) return "bg-emerald-600";
