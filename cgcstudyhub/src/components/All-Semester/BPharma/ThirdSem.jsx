...
import { PSem3Subjects } from "../../../Constants/Pharms";
                ...
                >
                    ...
                    <div className="w-full max-w-4xl space-y-8">
                        <Suspense fallback={<div className="text-white">Loading Notes...</div>}>
                            {PSem3Subjects.map((subject, index) => (
...
const UnitLink = ({ unit, delay }) => {
    ...
    const getBadgeColor = () => {
        ...
        if (label.includes("mst")) return "bg-emerald-600";
        if (label.includes("ptu")) return "bg-cyan-600";
        return "bg-gray-600";
    };
